...
#### Ejs Templates
* /index                      ---for users to create polls
* /user/:user_id              ---for users to admin all his polls
* polls/:poll_id              --- Link send to voters 
* polls/:poll_id/submission_id   ---for user to see one submission 
* polls/:poll_id/result          ---final result page of a poll
